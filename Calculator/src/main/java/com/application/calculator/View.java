...
public class View implements Initializable, CalculatorContract.CalculatorView {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        equal.setOnAction(this::calculate);
    }
    ...
    private void calculate(ActionEvent event) {
        ...
        calculationData.setNumber1(n1);
        calculationData.setNumber2(n2);
        calculationData.setOperator(op);

        presenter.calculateResult(calculationData);
    }
